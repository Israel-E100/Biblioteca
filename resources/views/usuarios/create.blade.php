...
<main class="flex-1 p-4 sm:p-6 lg:p-10 flex flex-col">
    ...
    <div class="w-full mx-auto max-w-2xl bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('usuarios.store') }}" method="POST" class="p-6 sm:p-8">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <select name="user_type" value="{{ old('email') }}" id="user_type" 
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">Contraseña</label>
